 ...
 * ギャロップを3コマで描き、CSSでコマを切り替える(のびる → ちぢむ → 前足で着地)。足は短め(かわいい)の曲がった太い線で、パタパタ振らない。しっぽはご機嫌に真上へピン */
export function runSvg(coat: Coat = 'seal'): string {
  ...
  return `<svg viewBox="0 0 330 210" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ${frame(1, { // のびる(4本とも宙に浮く)
      ...
      ff: 'M226 112 Q248 134 268 133', fn: 'M212 114 Q234 141 257 143',
      bf: 'M106 112 Q84 134 65 134', bn: 'M94 116 Q73 145 52 146',
      head: 'translate(200 -12) rotate(6 100 100)' })}
    ${frame(2, { // ちぢむ(背中が丸くなり、後ろ足が前へ)
      tail: 'M98 98 C94 70 94 40 96 14 Q98 0 110 6',
      body: 'M84 110 C82 82 112 72 152 72 C198 72 238 80 244 106 C248 132 226 142 194 142 L120 142 C98 142 86 130 84 110 Z',
      ff: 'M212 116 Q211 143 198 152', fn: 'M200 118 Q199 148 184 158',
      bf: 'M114 116 Q128 142 143 147', bn: 'M104 118 Q118 149 134 156',
      head: 'translate(186 -12) rotate(-3 100 100)' })}
    ${frame(3, { // 前足で着地、後ろ足でける
      tail: 'M90 100 C86 72 86 42 88 16 Q90 2 102 8',
      body: 'M76 106 C74 82 104 72 146 72 L206 74 C240 76 258 92 258 112 C258 132 238 142 206 142 L112 142 C88 142 76 128 76 106 Z',
      ff: 'M222 118 Q232 145 237 159', fn: 'M210 120 Q219 150 222 165',
      bf: 'M106 118 Q94 145 77 153', bn: 'M96 120 Q84 151 65 160',
      head: 'translate(196 -12)' })}
